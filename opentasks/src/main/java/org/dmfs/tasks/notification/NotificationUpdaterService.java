...
public class NotificationUpdaterService extends Service
{
    ...
    private static final String CHANNEL_PINNED = "org.dmfs.opentasks.pinned";
    ...
    private final NotificationCompat.Builder mBuilder = new Builder(this, NotificationCompat.CATEGORY_ALARM);
    ...
    public void onCreate()
    {
        ...
        if (VERSION.SDK_INT >= 26)
        {
            ...
            nm.createNotificationChannel(new NotificationChannel(CHANNEL_PINNED, "Pinned Tasks", NotificationManagerCompat.IMPORTANCE_DEFAULT));

            nm.createNotificationChannel(new NotificationChannel(NotificationCompat.CATEGORY_ALARM, "Alarms", NotificationManagerCompat.IMPORTANCE_HIGH));

            // note this notification is to make Android happy, it should never be visible to the user
            startForeground(DUMMY_NOTIFICATION_ID, new NotificationCompat.Builder(this, NotificationCompat.CATEGORY_ALARM).setTicker("OpenTasks")
